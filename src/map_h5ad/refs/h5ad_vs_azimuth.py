...
# --- 配置路径 ---
ref_path = r"C:\Users\Orangeeee\Downloads\5e1880b9-b680-4fe7-b929-51a18603ba99.h5ad"
input_dir = r"G:\Secondary_analysis\Organized_by_Tissue\Heart"
...
for query_path in pbar:
    ...
    try:
        ...
        adata.obs['azimuth_label_tabula'] = adata_map.obs['cell_type']
        adata.obsm['X_umap_proj_tabula'] = adata_map.obsm['X_umap']
